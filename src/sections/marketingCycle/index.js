...
export default function MarketingCycle() {
  return (
    <div className={styles.marketing}>
      <h2 className={`heading-font`}>THE MARKETING CYCLE</h2>
      ...
      <div className={styles.sectionContainer}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>
              ...
              business cards, brochures, and digital space. A design element can
              be as simple as a logo; however, elements can also be certain
              lines, shapes, and patterns that can be adjusted and scaled across
        ...
        <div className={styles.section}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>
              Using the right material is just as important as the design. There
              is no use in a great design without an equally great product. Our
              marketing materials are made and printed in the USA. We also offer
              digital exports of vector elements for you and your team.
            </p>
          </div>
        </div>
